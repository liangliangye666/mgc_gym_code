...
void standMode_step(standmode_output_t* standmode_output, standmode_input_t* standmode_input) {
  ...
  //     tau_cmd[static_cast<int>(y4a::Joints::left_hip_roll_joint)];
  standmode_output->joints_cmd.joint_k_pitch_l.torque_cmd = tau_cmd[static_cast<int>(y4a::Joints::left_knee_joint)];
  standmode_output->joints_cmd.joint_w_pitch_l.torque_cmd = tau_cmd[static_cast<int>(y4a::Joints::left_wheel_joint)];

  standmode_output->joints_cmd.joint_h_pitch_r.torque_cmd = tau_cmd[static_cast<int>(y4a::Joints::right_hip_pitch_joint)];
  // standmode_output->joints_cmd.joint_h_roll_r.torque_cmd =
  //     tau_cmd[static_cast<int>(y4a::Joints::right_hip_roll_joint)];
  standmode_output->joints_cmd.joint_k_pitch_r.torque_cmd = tau_cmd[static_cast<int>(y4a::Joints::right_knee_joint)];
  standmode_output->joints_cmd.joint_w_pitch_r.torque_cmd = tau_cmd[static_cast<int>(y4a::Joints::right_wheel_joint)];
