...
void RobotModel::UpdateRealJointStates(standmode_output_t* standmode_output, standmode_input_t* standmode_input) {
  ...
  q_rpy[7] = standmode_input->joints_status.joint_k_pitch_l.pos_fb;
  q_rpy[8] = standmode_input->joints_status.joint_w_pitch_l.pos_fb;

  q_rpy[9] = standmode_input->joints_status.joint_h_pitch_r.pos_fb;
  // q_rpy[11] = standmode_input->joints_status.joint_h_roll_r.pos_fb;
  q_rpy[10] = standmode_input->joints_status.joint_k_pitch_r.pos_fb;
  q_rpy[11] = standmode_input->joints_status.joint_w_pitch_r.pos_fb;
  ...
  q_pino[8] = standmode_input->joints_status.joint_k_pitch_l.pos_fb;
  q_pino[9] = standmode_input->joints_status.joint_w_pitch_l.pos_fb;
  q_pino[10] = standmode_input->joints_status.joint_h_pitch_r.pos_fb;
  // q_pino[12] = standmode_input->joints_status.joint_h_roll_r.pos_fb;
  q_pino[11] = standmode_input->joints_status.joint_k_pitch_r.pos_fb;
  q_pino[12] = standmode_input->joints_status.joint_w_pitch_r.pos_fb;
  ...
  qdot[7] = standmode_input->joints_status.joint_k_pitch_l.vel_fb;
  qdot[8] = standmode_input->joints_status.joint_w_pitch_l.vel_fb;

  qdot[9] = standmode_input->joints_status.joint_h_pitch_r.vel_fb;
  // qdot[11] = standmode_input->joints_status.joint_h_roll_r.vel_fb;
  qdot[10] = standmode_input->joints_status.joint_k_pitch_r.vel_fb;
  qdot[11] = standmode_input->joints_status.joint_w_pitch_r.vel_fb;
