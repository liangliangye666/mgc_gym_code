 ...
 */
#    if defined(__APPLE_CC__) || (defined(__STDC_VERSION__) && (__STDC_VERSION__ >= 199901L)) || (defined(_MSC_VER) && (_MSC_VER >= 1900))
...
#    if (defined(_MSC_VER) && _MSC_VER >= 1500) || defined(__x86_64__) || defined(__LP64__) || defined(__LCC64__)
...
#    if defined(_WIN64) || (defined(__APPLE__) && defined(__LP64__)) || defined(__x86_64__) || defined(__LP64__)
...
#    if defined(_MSC_VER) || (defined(__BORLANDC__) && __BORLANDC__ >= 0x530) || (defined(__WATCOMC__) && __WATCOMC__ >= 1100) || defined(__LCC64__)
#      ifdef INT64_T
 ...
 * in windows.
 */
#      define uint64_to_double(u) (((u) > _I64_MAX) ? (double)(__int64)((u) - _I64_MAX - 1) + (double)_I64_MAX + 1 : (double)(__int64)(u))
...
#      define double_to_uint64(d)                                                                                              \
        (((d) >= 18446744073709551616.0) ? 0xffffffffffffffffULL                                                               \
         : ((d) >= 0.0)                  ? ((d) >= 9223372036854775808.0) ? double_to_uint64_helper(d) : (unsigned __int64)(d) \
                                         : 0ULL)
#    else
...
#      else
#        define double_to_uint64(d) \
          (((d) >= 18446744073709551616.0) ? (unsigned long long)0xffffffffffffffffULL : ((d) >= 0) ? (unsigned long long)(d) : (unsigned long long)0)
#      endif
#    endif
