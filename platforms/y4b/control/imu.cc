...
//   ros_publisher_->Publish("y4b/est/imu_raw_euler", ori_base_world.euler);
//   ros_publisher_->Publish("y4b/est/imu_raw_omega", ori_base_local.omega);
//   ros_publisher_->Publish("y4b/est/imu_raw_acc", ori_base_local.acc);
...
//   ros_publisher_->Publish("y4b/est/imu_euler", ori_base_local.euler);
//   ros_publisher_->Publish("y4b/est/imu_omega", ori_base_local.omega);
//   ros_publisher_->Publish("y4b/est/imu_acc", ori_base_local.acc);
}
