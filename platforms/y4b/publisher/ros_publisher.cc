  ...
  switch (joint_vector.size()) {
    case 1:
      ...
      vector1d_publisher_[topic_name] =
          (this->create_publisher<y4b_msgs::msg::Vector1d>(
    ...
    case 2:
      ...
      vector2d_publisher_[topic_name] =
          (this->create_publisher<y4b_msgs::msg::Vector2d>(
              topic_name, GetBestEffortQoS(msg_queue_size_)));
      vector_callback(topic_name, joint_vector);
      break;
    case 3:
      ...
      vector3d_publisher_[topic_name] =
          (this->create_publisher<y4b_msgs::msg::Vector3d>(
              topic_name, GetBestEffortQoS(msg_queue_size_)));
      vector_callback(topic_name, joint_vector);
      break;
    case 4:
      ...
      vector4d_publisher_[topic_name] =
          (this->create_publisher<y4b_msgs::msg::Vector4d>(
              topic_name, GetBestEffortQoS(msg_queue_size_)));
      vector_callback(topic_name, joint_vector);
      break;
    ...
    case 6:
      ...
      vector6d_publisher_[topic_name] =
          (this->create_publisher<y4b_msgs::msg::Vector6d>(
              topic_name, GetBestEffortQoS(msg_queue_size_)));
      vector_callback(topic_name, joint_vector);
      break;
    ...
    case 7:
      ...
      vector7d_publisher_[topic_name] =
          (this->create_publisher<y4b_msgs::msg::Vector7d>(
              topic_name, GetBestEffortQoS(msg_queue_size_)));
      vector_callback(topic_name, joint_vector);
      break;
    ...
    case 8:
      ...
      vector8d_publisher_[topic_name] =
          (this->create_publisher<y4b_msgs::msg::Vector8d>(
              topic_name, GetBestEffortQoS(msg_queue_size_)));
      vector_callback(topic_name, joint_vector);
      break;
    ...
    case 9:
      ...
      vector9d_publisher_[topic_name] =
          (this->create_publisher<y4b_msgs::msg::Vector9d>(
              topic_name, GetBestEffortQoS(msg_queue_size_)));
      vector_callback(topic_name, joint_vector);
      break;
    ...
    case 10:
      ...
      all_joint_publisher_[topic_name] =
          (this->create_publisher<y4b_msgs::msg::AllJointStates>(
              topic_name, GetBestEffortQoS(msg_queue_size_)));
      all_joints_callback(topic_name, joint_vector);
      break;
    ...
    case 12:
      ...
      state_estimator_publisher_[topic_name] =
          (this->create_publisher<y4b_msgs::msg::StateEstimator>(
              topic_name, GetBestEffortQoS(msg_queue_size_)));
      state_estimator_callback(topic_name, joint_vector);
      break;
    ...
    case 16:
      ...
      all_joint_with_base_publisher_[topic_name] =
          (this->create_publisher<y4b_msgs::msg::AllJointWithBaseStates>(
              topic_name, GetBestEffortQoS(msg_queue_size_)));
      all_joints_with_base_callback(topic_name, joint_vector);
      break;
    ...
    case 22:
      ...
      vector22d_publisher_[topic_name] =
          (this->create_publisher<y4b_msgs::msg::Vector22d>(
              topic_name, GetBestEffortQoS(msg_queue_size_)));
      vector_callback(topic_name, joint_vector);
      break;
...
void Publisher::Publish(const std::string& topic_name, double double_data) {
  ...
  double_publisher_[topic_name] =
      (this->create_publisher<y4b_msgs::msg::Double>(
          topic_name, GetBestEffortQoS(msg_queue_size_)));
  double_callback(topic_name, double_data);
}
...
void Publisher::all_joints_callback(const std::string& topic_name,
                                    Eigen::VectorXd joint_vector) {
  y4b_msgs::msg::AllJointStates all_jointState;
...
void Publisher::all_joints_with_base_callback(const std::string& topic_name,
                                              Eigen::VectorXd joint_vector) {
  y4b_msgs::msg::AllJointWithBaseStates all_joint_with_baseState;
  {
...
void Publisher::state_estimator_callback(const std::string& topic_name,
                                         Eigen::VectorXd joint_vector) {
  y4b_msgs::msg::StateEstimator state_estimator;
...
void Publisher::vector_callback(const std::string& topic_name,
  ...
  switch (joint_vector.size()) {
    case 1: {
      y4b_msgs::msg::Vector1d vector1d_msg;
    ...
    case 2: {
      y4b_msgs::msg::Vector2d vector2d_msg;
      for (int i = 0; i < joint_vector.size(); i++) {
    ...
    case 3: {
      y4b_msgs::msg::Vector3d vector3d_msg;
      for (int i = 0; i < joint_vector.size(); i++) {
    ...
    case 4: {
      y4b_msgs::msg::Vector4d vector4d_msg;
      for (int i = 0; i < joint_vector.size(); i++) {
    ...
    case 6: {
      y4b_msgs::msg::Vector6d vector6d_msg;
      for (int i = 0; i < joint_vector.size(); i++) {
    ...
    case 7: {
      y4b_msgs::msg::Vector7d vector7d_msg;
      for (int i = 0; i < joint_vector.size(); i++) {
    ...
    case 8: {
      y4b_msgs::msg::Vector8d vector8d_msg;
      for (int i = 0; i < joint_vector.size(); i++) {
    ...
    case 9: {
      y4b_msgs::msg::Vector9d vector9d_msg;
      for (int i = 0; i < joint_vector.size(); i++) {
    ...
    case 14: {
      y4b_msgs::msg::Vector14d vector14d_msg;
      for (int i = 0; i < joint_vector.size(); i++) {
    ...
    case 22: {
      y4b_msgs::msg::Vector22d vector22d_msg;
      for (int i = 0; i < joint_vector.size(); i++) {
...
void Publisher::double_callback(const std::string& topic_name,
                                double double_data) {
  y4b_msgs::msg::Double double_msg;
